  ...
  return (
    <>
      ...
      <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
        <DrawerContent className="fixed right-0 top-0 h-screen w-[40vw] rounded-none border-l border-gray-200 bg-white">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              {!isIntegrationTask && (
                <TabsContent value="assignment" className="mt-4">
                  Assignment configuration content
                </TabsContent>
              )}
              {isIntegrationTask && (
              ...
              <TabsContent value="notifications" className="mt-4">
                Notifications configuration content
              </TabsContent>
              {!isIntegrationTask && (
                <>
                  <TabsContent value="actions" className="mt-4">
                    Actions configuration content
                  </TabsContent>
                  <TabsContent value="visibility" className="mt-4">
                    Visibility configuration content
                  </TabsContent>
                </>
              )}
            </Tabs>
